			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-12 event-excerpt">
						<h2>Night of the living fest</h2>
						<p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam volutpat arcu quis pretium imperdiet. Nam rhoncus et eros quis convallis. Maecenas commodo egestas sodales. Morbi iaculis turpis in nulla venenatis, at placerat metus consectetur. Nulla consequat iaculis suscipit. </p>
					</div>
				</div>

				<div class="row">
					<div class="col-sm-6 highlight-left">
						<div class="highlight-image">
							<img src="images/photos/photo6.jpg" alt="" />
							<span>Highlight</span>
						</div>
						<h4>Suspendisse tempor felis elementum</h4>
						<p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam volutpat Maecenas commodo egestas sodales. Morbi iaculis turpis in nulla venenatis.</p>
					</div>
					<div class="col-sm-6 highlight-right">
						<div class="highlight-image">
							<img src="images/photos/photo7.jpg" alt="" />
							<span>Highlight</span>
						</div>						
						<h4>Etiam volutpat Maecenas commodo</h4>
						<p>Suspendisse tempor felis elementum. Interdum et malesuada fames ac ante ipsum primis in faucibus. Morbi iaculis turpis in nulla venenatis.</p>
					</div>
				</div>
