        ...
        <div class="tab-pane active" id="mainmenu">
          ...
          <?php if(Auth::User()->role=='admin1'){ ?>      
            <li class="nav-parent ">
             ...
             <ul class="children">
                <li><a  href="{{URL::to('executor/single')}}"><i class="fa fa-thumbs-o-up"></i><span> Single Contract</span></a></li>
                                                                            ...
                                                                            <table class="table table-bordered">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                     ...
                                                                                     <tr>
                                                                                        <td >
                                                                                           Do you want to send as FINAL INVOICE ? &nbsp;
                                                                                  
                                                                                           <input type="radio" name="invoicestatus"  value="INVOICE"> &nbsp;YES
                                                                                            <input type="radio" name="invoicestatus"  value="PROFORMA INVOICE">&nbsp; NO
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="pis-btm-left" valign="top" colspan="4">
