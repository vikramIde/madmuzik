...
<section>
  ...
  <div class="leftpanel">
   ...
   <li class="nav-parent active">
              <a  href=""><i class="fa fa-thumbs-o-up"></i><span> Invoicing</span></a>
             <ul class="children">
                <li class="active"><a  href="{{URL::to('executor/single')}}"><i class="fa fa-thumbs-o-up"></i><span> Single Contract</span></a></li>
              <li ><a  href="{{URL::to('executor/annual')}}"><i class="fa fa-thumbs-o-up"></i><span> Annual Contract</span></a></li>
              </ul>
            </li>
      ...
      <div class="row">
          ...
          <div class="tab-content mb20">
            ...
            <div class="tab-pane active" id="popular5">
                ...
                <form action="{{ url('executor/invoice') }}" method="post" enctype="multipart/form-data"  name="form1" id="form1">

                                                        <input type="hidden" name="dealid" value="<?php echo $data->Id ?>">

                                                          <input type="hidden" value="<?php echo $data->mlead;?>" name="mlead">
                                                           <input type="hidden" value="<?php echo $data->mname;?>" name="mname">
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    <select name="rep_id" class="form-control" id="select1" style="width: 100%">
                                                                                     ...
                                                                                     ?>
                                                                                            ...
                                                                                            if($data->Dealtype=='annual'){
                                                                                              ...
                                                                                              <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                          <input autocomplete="off" name="convalue" class="form-control" type="text" value="{{$data->Dealvalue}}">
                                                                                                           <input  autocomplete="off" name="concode" class="form-control" type="hidden" value="{{$data->concode}}">
                                                                                                </td>
                                                                                           <?php
                                                                                         }
                                                                                         ?>
                                                                    ...
                                                                    <div id="content">
                                                                        ...
                                                                        <div id="invoice_body">
                                                                                ...
                                                                                <tbody class="inputs">
                                                                                    ...
                                                                                    <tr class="valuesinv annual single report">
                                                                                        ...
                                                                                        <?php if($data->Dealtype=='annual'){
                                                                                            ...
                                                                                            ?>
                                                                                            <select name="eventname" class="form-control"  id="select1" style="width: 100%">
                                                                                      ...
                                                                                      <option value="{{$data->Eventcode}}|{{$data->Eventname}}">{{$data->Eventname}}</option>
                                                                                        ...
                                                                                        <td class="mono w15">
                                                                                            ...
                                                                                            ?>
                                                                                            <select name="currency_type" id="currency" class="form-control currency" style="width: 100%">
                                                                            ...
                                                                            <tr>
                                                                              ...
                                                                              <input type="text"  class="form-control"  autocomplete="off" name="percentage[]" placeholder="enter the percentage" >
                                                                              </td>
                                                                               <td>
                                                                              <input type="text"  class="form-control " autocomplete="off" name="pamount[]" placeholder="amount">
                                                                              </td>
                                                                              <td>
                                                                                <input type="text"  class="form-control dob" autocomplete="off" name="date[]"  placeholder="date">
                                                                              </td>
...
?>
 ...
 <script type="text/javascript">
    ...
    if (amount !== '' && tax !== '' && currency =='INR') {
        ...
        calcObject.amountTax =Math.round((amount * tax) / 100) ;

         calcObject.amountSwachTax = Math.round((amount * swach_tax) / 100);

        calcObject.subTotal = Math.round(parseFloat(amount) );

        calcObject.amountTotal = Math.round(parseFloat(amount) + parseFloat(calcObject.amountTax) +parseFloat(calcObject.amountSwachTax));

        calcObject.amountSubTotal =Math.round(parseFloat(calcObject.amountTax) +parseFloat(calcObject.amountSwachTax));
      ...
      calcObject.amountTax =amount;
        ...
        calcObject.amountTotal = Math.round(parseFloat(amount)) ;
