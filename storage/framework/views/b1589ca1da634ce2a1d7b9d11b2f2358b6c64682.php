		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href=""><img src="<?php echo e(asset('/images/logo.png')); ?>" alt="MadMuzik" /></a>
				</div>
				<div class="collapse navbar-collapse" id="main-nav">
					<ul class="nav navbar-nav navbar-right">
						<li class="current"><a href="<?php echo e(url('/site/home')); ?>">Home</a></li>
						<li class=""><a href="<?php echo e(url('/site/aboutus')); ?>">About Us</a></li>
						<li class=""><a href="<?php echo e(url('/site/partycalender')); ?>">Party Calender</a></li>
						<li class="dropdown">
							<a href="" class="dropdown-toggle disabled" data-toggle="dropdown">Albums <b class="caret"></b></a>
							<ul class="dropdown-menu">
								<li><a href="<?php echo e(url('/site/listalbums')); ?>" >List Albums</a></li>
								<li><a href="<?php echo e(url('/site/viewalbum')); ?>" >View Album</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="" class="dropdown-toggle disabled" data-toggle="dropdown">Artiste <b class="caret"></b></a>
							<ul class="dropdown-menu">
								<li><a href="<?php echo e(url('/site/listartiste')); ?>" >List Artiste</a></li>
								<li><a href="<?php echo e(url('/site/viewartiste')); ?>" >View Artiste</a></li>
							</ul>
						</li>
						<li class=""><a  href="<?php echo e(url('/site/donate')); ?>" >Donate</a></li>
						<!--<li class="dropdown">
						...
						<li><a href="<?php echo e(url('/site/contact')); ?>" >Contact Us</a></li>
					</ul>
				</div>
			</div>
		</nav>
